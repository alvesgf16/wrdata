...
def test_factory_creates_csv_reader() -> None:
...
def test_factory_creates_excel_reader() -> None:
...
def test_factory_creates_csv_reader_with_custom_filepath() -> None:
...
def test_factory_creates_excel_reader_with_custom_filepath() -> None:
...
def test_factory_uses_default_reader_type_from_settings() -> None:
...
def test_factory_raises_error_for_unsupported_reader_type() -> None:
